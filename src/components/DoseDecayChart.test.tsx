...
function curve(overrides: Partial<DecayCurve> = {}): DecayCurve {
  return {
    ...
    points: [
      { dayOffset: 0, meanImprovement: 1.5, sampleSize: 5, thin: true },
      { dayOffset: 1, meanImprovement: 1.0, sampleSize: 4, thin: true },
    ],
    ...overrides,
  }
}
...
test('a curve with every point null is treated as no data', () => {
  const empty = curve({
    points: [
      { dayOffset: 0, meanImprovement: null, sampleSize: 0, thin: true },
      { dayOffset: 1, meanImprovement: null, sampleSize: 0, thin: true },
    ],
  })
